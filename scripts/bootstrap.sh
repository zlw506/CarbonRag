...
step "Preparing backend environment template"
...
step "Next steps"
echo "Local dev standard entry: bash scripts/dev-local.sh"
echo "Frontend local env file: frontend/.env.local (generated by dev-local if missing)"
