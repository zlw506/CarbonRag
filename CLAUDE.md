...
This project is indexed by GitNexus as **CarbonRag** (12375 symbols, 25291 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Work in the Tests area (349 symbols) | `.claude/skills/generated/tests/SKILL.md` |
| Work in the Knowledge area (297 symbols) | `.claude/skills/generated/knowledge/SKILL.md` |
| Work in the Rag area (202 symbols) | `.claude/skills/generated/rag/SKILL.md` |
| Work in the Services area (119 symbols) | `.claude/skills/generated/services/SKILL.md` |
| Work in the Endpoints area (106 symbols) | `.claude/skills/generated/endpoints/SKILL.md` |
...
| Work in the Retrieval area (54 symbols) | `.claude/skills/generated/retrieval/SKILL.md` |
...
| Work in the Kb area (42 symbols) | `.claude/skills/generated/kb/SKILL.md` |
